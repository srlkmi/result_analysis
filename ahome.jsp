...
<table><tr><td><font style="color: navy;">Department:</font></td><td><select name="branch" id="select">
					...
					<tr><td><br></td></tr>
<tr><td><font style="color: navy;">Find Staff:-</font></td><td><input type="text" align="right" name="findName" onkeyup="sendInfo()"></input></td></tr></table>
<div id="right" align="right">

<a href="create.jsp"><font style="color: navy;"><B>Create New Staff</B></font></a>
</div>
